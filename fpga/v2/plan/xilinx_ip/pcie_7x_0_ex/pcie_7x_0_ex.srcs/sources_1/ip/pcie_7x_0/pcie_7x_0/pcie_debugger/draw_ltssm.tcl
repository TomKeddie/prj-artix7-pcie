...
set lnk_7_2 [$c create line 8.5c 5.15c 12.7c 3.7c -arrow first -tags item -width 0.3m]
...
set lnk_b_a [$c create line 11.5c 13c 11.5c 12c -arrow last -tags item -width 0.3m]
...
1   {grp 0 visited 0 name "Detect.Quiet"}
2   {grp 0 visited 0 name "Detect.Active"}
3   {grp 0 visited 0 name "Detect.Active"}
4   {grp 1 visited 0 name "Polling.Active"}
5   {grp 1 visited 0 name "Polling.Configuration"}
6   {grp 1 visited 0 name "Polling.Compliance,Pre_send_EIOS"}
7   {grp 1 visited 0 name "Polling.Compliance,Pre_Timeout"}
8   {grp 1 visited 0 name "Polling.Compliance,Send_pattern"}
9   {grp 1 visited 0 name "Polling.Compliance,Post_Send_EIOS"}
10  {grp 1 visited 0 name "Polling.Compliance,Post_Timeout"}
11  {grp 1 visited 0 name "Polling.Compliance,Send_pattern"}
12  {grp 2 visited 0 name "Configuration.Linkwidth,State 0"}
13  {grp 2 visited 0 name "Configuration.Linkwidth,State 1"}
14  {grp 2 visited 0 name "Configuration.Linkwidth,Accept 0"}
15  {grp 2 visited 0 name "Configuration.Linkwidth,Accept 1"}
16  {grp 2 visited 0 name "Configuration.Lanenum.Accept"}
17  {grp 2 visited 0 name "Configuration.Complete x1"}
18  {grp 2 visited 0 name "Configuration.Complete x2"}
19  {grp 2 visited 0 name "Configuration.Complete x4"}
20  {grp 2 visited 0 name "Configuration.Complete x8"}
21  {grp 2 visited 0 name "Configuration.Idle"}
22  {grp 3 visited 0 name "L0"}
23  {grp 6 visited 0 name "L1.Entry0"}
24  {grp 6 visited 0 name "L1.Entry1"}
25  {grp 6 visited 0 name "L1.Entry2"}
26  {grp 6 visited 0 name "L1.Idle"}
27  {grp 6 visited 0 name "L1.Exit"}
28  {grp a visited 0 name "Recovery.RcvrLock"}
29  {grp c visited 0 name "Recovery.RcvrCfg"}
30  {grp b visited 0 name "Recovery.Speed 0"}
31  {grp b visited 0 name "Recovery.Speed 1"}
32  {grp e visited 0 name "Recovery.Idle"}
33  {grp 8 visited 0 name "HOT_RESET"}
34  {grp 7 visited 0 name "DISABLED Entry 0"}
35  {grp 7 visited 0 name "DISABLED Entry 1"}
36  {grp 7 visited 0 name "DISABLED Entry 2"}
37  {grp 7 visited 0 name "DISABLED Idle"}
38  {grp 2 visited 0 name "Root Port, Configuration.Linkwidth,State 0"}
39  {grp 2 visited 0 name "Root Port, Configuration.Linkwidth,State 1"}
40  {grp 2 visited 0 name "Root Port, Configuration.Linkwidth,State 2"}
41  {grp 2 visited 0 name "Root Port, Configuration.Linkwidth,Accept 0"}
42  {grp 2 visited 0 name "Root Port, Configuration.Linkwidth,Accept 1"}
43  {grp 2 visited 0 name "Root Port, Configuration.Linknum,Wait"}
44  {grp 2 visited 0 name "Root Port, Configuration.Linknum,Accept"}
45  {grp 2 visited 0 name "Timeout To Detect"}
46  {grp 9 visited 0 name "LOOPBACK Entry 0"}
47  {grp 9 visited 0 name "LOOPBACK Entry 1"}
48  {grp 9 visited 0 name "LOOPBACK Active 0"}
49  {grp 9 visited 0 name "LOOPBACK Exit 0"}
50  {grp 9 visited 0 name "LOOPBACK Exit 1"}
51  {grp 9 visited 0 name "LOOPBACK Master Entry 0"}
}     
