...
elaborate()
{
  xelab --relax --debug typical --mt auto -L jtag_axi -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie_7x_0 xil_defaultlib.pcie_7x_0 xil_defaultlib.glbl -log elaborate.log
}
